...
After adding ROIs to these images as if I were training a new classifier, I saved the data as `test_data.arff`.  I could then open this up in the Weka experimenter and use the `full_stack_classifier.model` on it.  This gives a kappa of 0.998 ± 0.001
