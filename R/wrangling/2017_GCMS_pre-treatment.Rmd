...
gc_tidy.7 <-
  ...
  mutate(RPA = case_when(ND            ~ 100/IS, # if peaks were always not detected
                         # Censor        ~ 100/IS, # or if their original areas were  < 1000
...
Q8 and Q13 shows up as an outlier in untransformed data. (Q8 is **much** stronger outlier if I don't censor peaks after blank subtraction---i.e. only RPA <= 0 get replaced with 500/IS)
