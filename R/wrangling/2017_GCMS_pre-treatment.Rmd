...
8. Set RPA for nondetects, censored, and all RPA <= 0  to 100/IS
...
gc_tidy.7 <-
  ...
  mutate(RPA = case_when(ND      ~ 100/IS, # if peaks were always not detected
                         RPA <=0 ~ 100/IS, # or if their areas after background subtraction <= 0
                         TRUE    ~ RPA),
...
# Check for compounds with low average Q-values
All compounds have mean Q-value > 90. 
