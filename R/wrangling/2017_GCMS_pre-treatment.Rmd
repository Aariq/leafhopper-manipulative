...
Q8 shows up as an outlier in the log transformed data, but not in the untransformed data. It's not a particularly extreme level of damage or leafhopper density either.
...
Q8 shows up as an outlier in both raw and log-transformed data.
