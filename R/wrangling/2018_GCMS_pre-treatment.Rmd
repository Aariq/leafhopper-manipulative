...
Here, J4 and J11 are really weird outliers.  Turns out the internal standard peaks are very small for some reason.  I'm guessing just a mistake applying it to the Twister.

# Remove outliers

I *could* fix these files by using the average Naphthalene-D8 peak from all the other files instead.  Nicole suggested this.
